...
for (var i = 0; i < numbers.length; i++) {
  //array te j koyta value ase oigular position ber korar jonn
...
for (var i = 0; i <= 20; i++) {
  console.log(i);
  if (i > 10) {
    //kono condition e break likhbo (condition er beshi hole break bondho hoye jabe) .jodi(i > 100) dei tahole 20 porjonto for loop er man porjonto jeye condition break hoye jabe.
    break;
  }
}
...
for (var i = 0; i < numbers.length; i++) {
  //array te jokhon 170 ashbe tokhon e break korbe.
  var number = numbers[i];
  if (number > 100) {
    break;
  }
...
for (var i = 0; i < numbers.length; i++) {
  //array te jokhon  ashbe tokhon e continue korbe.
  var number = numbers[i];
  if (number > 50) {
    continue;
  }
